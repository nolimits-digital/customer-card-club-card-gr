  ...
  return (
    <div className="fixed bottom-nav z-[999] bottom-0 max-w-[480px] xsm:max-w-[100%] w-full bg-white" style={{ borderTop: '1px solid #E8E8E8' }}>
      <div className="flex items-center justify-between">
        <div className="w-1/3">
          <Link href="/" className={`flex flex-col items-center pb-[10px] pt-[20px] justify-center w-full text-center ${router.pathname === '/' ? 'active' : ''}`}>
            ...
            <span className="font-[500] text-[15px] text-[#000] mt-[8px]">Transactions</span>
          </Link>
        </div>
        <div className="w-1/3">
          <Link href="/cards" className={`flex flex-col items-center pb-[10px] pt-[20px] justify-center w-full text-center ${router.pathname === '/cards' ? 'active' : ''}`}>
            ...
            <span className="font-[500] text-[15px] text-[#000] mt-[8px]">Clubcard</span>
          </Link>
        </div>
        <div className="w-1/3">
          <Link href="/my-account" className={`flex flex-col items-center pb-[10px] pt-[20px] justify-center w-full text-center ${router.pathname === '/my-account' ? 'active' : ''}`}>
            ...
            <span className="font-[500] text-[15px] text-[#000] mt-[8px]">My Account</span>
          </Link>
        </div>
      </div>
    </div>
