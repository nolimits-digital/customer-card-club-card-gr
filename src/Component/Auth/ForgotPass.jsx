    ...
    <div className="py-[20px] h-[100vh] flex justify-center items-center bg-[#f0f7f6] relative">
        <div className="relative z-10 bg-white rounded-[8px] max-w-[420px] w-full mx-auto px-[30px] md:px-[20px] py-[40px]" style={{ boxShadow: 'rgba(145, 158, 171, 0.3) 0px 0px 2px 0px, rgba(145, 158, 171, 0.12) 0px 12px 24px -4px' }}>
          ...
          <form action='/auth'>
            ...
            <button type='submit' variant="contained" className="bg-[#5985fd] opacity-[0.9] hover:opacity-[1] delay-75 h-[40px] w-full text-[16px] font-[600] rounded-[6px] text-white">Submit</button>
            <Link href="/auth" className="bg-[#5985fd3a] hover:bg-[#5985fd59] flex items-center justify-center delay-75 h-[40px] w-full text-[16px] font-[600] rounded-[6px] mt-[20px] text-[#5985fd]">Back to Login</Link>
